...
Green-DCC uses a unified, agent-based **spatio-temporal** scheduling framework, executed entirely by the Top-Level Agent.
...
By centralizing both **where** and **when** decisions, Green-DCC exploits synergies across space and time: it drives down energy costs, cuts carbon emissions, and smooths utilization by holistically reacting to workload, price, and environmental signals.

.. image:: ../images/GreenDCCv3.png
   :scale: 15 %
   :alt: Unified Spatio-Temporal Scheduling in Green-DCC
   :align: center
