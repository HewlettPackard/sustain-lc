...
1. **Fork the Repository**  
   Fork the Green-DCC repository to your own GitHub account.
...
7. **Create a Pull Request**  
   Open a pull request on the original Green-DCC repository. Provide a clear description of what your changes do and any relevant information for the review process.
...
Green-DCC is licensed under the MIT License. For more details, please refer to the LICENSE_ file in the repository.
